...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        { "@type": "Offer", name: "Free", price: "0", priceCurrency: "USD", url: "https://ragfly.ai/#planes", description: "Para probar — ~1.000 páginas procesadas, multi-tenant con 2 entidades aisladas." },
        { "@type": "Offer", name: "Starter", price: "19", priceCurrency: "USD", url: "https://ragfly.ai/#planes", description: "Para un dev en solitario — ~4.000 páginas, multi-tenant con 5 entidades aisladas." },
        { "@type": "Offer", name: "Team", price: "95", priceCurrency: "USD", url: "https://ragfly.ai/#planes", description: "Para consultoras — ~10.000 páginas, hasta 25 entidades aisladas + control por Área y perfil." },
        { "@type": "Offer", name: "Scale", price: "490", priceCurrency: "USD", url: "https://ragfly.ai/#planes", description: "Producción a escala — ~60.000 páginas, hasta 150 entidades, Client LM/on-prem y BYO." },
